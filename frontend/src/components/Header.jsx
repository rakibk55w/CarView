            ...
            <div className="mx-auto flex max-w-7xl items-center gap-8 px-6 py-4">
                ...
                <nav className="ml-auto hidden items-center gap-5 md:flex">
                    ...
                    <button
                        ...
                        <FiSun
                            size={13}
                            className={`absolute left-1.5 z-10 transition
                                ${
                                    !darkMode
                                    ? "text-black"
                                    : "text-white"
                        ...
                        <FiMoon
                            size={13}
                            className={`absolute right-1.5 z-10 transition
                                ${
                                    darkMode
                                    ? "text-black"
                                    : "text-white"
                                ...
                                />
                        <div
                            className={`absolute z-0 h-5 w-5 rounded-full bg-white shadow transition-transform duration-300 ${
                                darkMode
                                ? "translate-x-10"
                                : "translate-x-1"
                            }`}
